  ...
  return (
    <div className={s.page}>
      <div className={s.headerRow}>
        <h1 className={s.title}>Perfil de administrador</h1>
      </div>

      <div className={s.layout}>
        {/* Card principal con el perfil */}
        <section className={s.card}>
          <h2 className={s.sectionTitle}>Información del administrador</h2>
          <p className={s.sectionText}>
            Revisa y actualiza los datos asociados a tu cuenta de administrador.
          </p>
        ...
        <section className={s.card}>
          <h2 className={s.sectionTitle}>Seguridad de la cuenta</h2>
          <p className={s.sectionText}>
            Desde aquí puedes cerrar sesión o eliminar tu cuenta de manera segura.
          </p>
